...
/***/ "./ClienteApp/app/modelo/pedidos.ts":
/*!******************************************!*\
  !*** ./ClienteApp/app/modelo/pedidos.ts ***!
  \******************************************/
...
/* harmony import */ var _produto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./produto */ "./ClienteApp/app/modelo/produto.ts");
...
/***/ "./ClienteApp/app/modelo/produto.ts":
/*!******************************************!*\
  !*** ./ClienteApp/app/modelo/produto.ts ***!
  \******************************************/
...
/* harmony import */ var _modelo_pedidos__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modelo/pedidos */ "./ClienteApp/app/modelo/pedidos.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DataServices = /** @class */ (function () {
    function DataServices(http) {
        this.http = http;
        this.pedido = new _modelo_pedidos__WEBPACK_IMPORTED_MODULE_3__["Pedido"]();
    }
    ...
    DataServices.prototype.adicionarProduto = function (produto) {
        ...
        if (itemSelecionado) {
            ...
            var item = void 0;
            item = new _modelo_pedidos__WEBPACK_IMPORTED_MODULE_3__["ItemPedido"]();
    ...
    DataServices.prototype.efetivarCompra = function () {
        ...
        return this.http.post("/api/pedido", this.pedido)
            ...
            _this.pedido = new _modelo_pedidos__WEBPACK_IMPORTED_MODULE_3__["Pedido"]();
            return true;
        });
    };
